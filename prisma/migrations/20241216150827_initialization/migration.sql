...
-- AddForeignKey
ALTER TABLE `_restaurantCategories` ADD CONSTRAINT `_restaurantCategories_A_fkey` FOREIGN KEY (`A`) REFERENCES `Categories`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
